///ryb_to_rgb_green_diff( red, yellow, blue, dR, dY, dB )
...
if ( argument5 ) {
    var _x0 = cubic_interpolation_diff( _b, color_get_green( c_magic_white  ), color_get_green( c_magic_blue   ) );
    var _x1 = cubic_interpolation_diff( _b, color_get_green( c_magic_yellow ), color_get_green( c_magic_green  ) );
    var _x2 = cubic_interpolation_diff( _b, color_get_green( c_magic_red    ), color_get_green( c_magic_purple ) );
    var _x3 = cubic_interpolation_diff( _b, color_get_green( c_magic_orange ), color_get_green( c_magic_black  ) );
} else {
